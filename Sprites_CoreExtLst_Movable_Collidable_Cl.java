...
{
	//n invalid methods-	privatea List<Sprite_Core_ClAb> sprites_ObsLst_Fld;
	private List<Sprite_CoreExt_Movable_Collidable_Cl> sprites_ObsLst_Fld;

	public Sprites_CoreExtLst_Movable_Collidable_Cl()
	{
		sprites_ObsLst_Fld = new ArrayList<Sprite_CoreExt_Movable_Collidable_Cl>();
	}
	...
	public Sprites_CoreExtLst_Movable_Collidable_Cl(int size)
	{
		...
		{
            //y- 			sprites_ObsLst_Fld.add( new Sprite_CoreExt_Movable_Collidable_Cl("/images/alien.jpg", x, y, 35, 35, 1) );
			//y- sprites_ObsLst_Fld.add( new Sprite_CoreExt_Movable_Collidable_Cl("/images/alien.jpg", x, y, 100, 100, 1) );
			sprites_ObsLst_Fld.add( new Sprite_CoreExt_Movable_Collidable_Cl("/images/ufo.png", x, y, 50, 50, 1) );
			...
			if( x >= Game_Main_JFrame_Cl.WIDTH - Game_Main_JFrame_Cl.BORDER_SAFETY_MARGIN)
			{
				...
				//y- y += 75;
				y += (sprites_ObsLst_Fld.get(i).getHeight() * 1);
				sprites_ObsLst_Fld.get(i).setPos(x,y);
			}
			//y- x += 75;
			x += (sprites_ObsLst_Fld.get(i).getWidth() * 1);
		}
	}

	public void add(Sprite_CoreExt_Movable_Collidable_Cl sprite_Ob_In)
	{
	   sprites_ObsLst_Fld.add(sprite_Ob_In);
	}

	public void draw( Graphics window )
	{
		//n invalid methods-			for( Sprite_Core_ClAb al : sprites_ObsLst_Fld)
		for( Sprite_CoreExt_Movable_Collidable_Cl sprite_Ob_In : sprites_ObsLst_Fld)
	...
	{
		Iterator<Sprite_CoreExt_Movable_Collidable_Cl> playerBots_Iterator = sprites_ObsLst_Fld.iterator();
